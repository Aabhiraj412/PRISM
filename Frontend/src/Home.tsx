        ...
        <div className="min-h-screen bg-gradient-to-b text-black from-gray-100 to-gray-200">
            <header className="p-6 bg-white shadow-sm">
                <div className="container mx-auto flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-2xl font-bold text-purple-500">PRISM</span>
                    </div>
                    <nav>
            ...
            <main className="container mx-auto px-6 py-12">
                <section className="text-center mb-16">
                    <h1 className="text-4xl font-bold mb-4">Secure Your Sensitive Data with PRISM: Privacy Redaction and Information Security Management</h1>
                    <p className="text-xl text-gray-600 mb-8">Advanced redaction and anonymization tool for businesses and individuals</p>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle className="flex items-center space-x-2">
                                    ...
                                    <span>Advanced Redaction</span>
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p>Powerful algorithms to securely redact sensitive primaryrmation from various document formats.</p>
                            </CardContent>
                        </Card>
                        <Card>
                            <CardHeader>
                            ...
                            <CardContent>
                                <p>Lightning-fast redaction process, handling large volumes of data efficiently.</p>
                            </CardContent>
                        </Card>
                        <Card>
                            <CardHeader>
                            ...
                            <CardContent>
                                <p>Ensures compliance with data protection regulations like GDPR, HIPAA, and more.</p>
                            </CardContent>
                        </Card>
                    </div>
                </section>
            ...
            <footer className="bg-gray-800 text-white py-8">
                <div className="container mx-auto px-6 text-center">
                    <p>&copy; 2024 RE-DACT. All rights reserved.</p>
                    <div className="mt-4">
